...
select distinct p.protagonista, (select avg(nota) 
from peliculas 
where protagonista=p.protagonista) 
from peliculas as p;
...
select * 
from Peliculas As P 
where P.Nota < (select P.Nota from Peliculas As P inner join Reparto As R where R.DNI=P.Protagonista and R.Nombre like "Will");
...
select * 
from Peliculas As P 
where P.Nota > (select max(P.Nota) from Peliculas As P inner join Reparto As R where R.DNI=P.Protagonista and R.Apellido like "Clooney") 
